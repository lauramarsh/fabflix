...
public class MovieServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
    		...
    		// Query 
    		String query = "select movies.id, title, director, year, group_concat(distinct genres.name) as genre_list, group_concat(distinct stars.name) as stars_list, rating "
    		...
    		while (resultSet.next()) {
    			...
    			// <a href="/project1/browselist?page=0&genre=Action&title=&title-order=&rating-order=desc>Action</a>"
        		...
        		out.println("<tr><th scope=\"row\">Genre</th><td>" + genresHyperlinked + "</td></tr>");
        		out.println("<tr><th scope=\"row\">Stars</th><td>" + movieStars + "</td></tr>");
